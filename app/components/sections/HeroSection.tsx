...
export default function HeroSection() {
  return (
    <section className="py-20 px-4 bg-gradient-to-r from-[#0B2C46] to-[#7E72FF] text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              AUTOCRYPT EVI Platform: 전기차를 위한 Security-Native AI
            </h1>
            <p className="text-xl mb-8">
              전기차 지식(EVPEDIA), 충전소 위치(EV Locate), 보안 기술의 완벽한 통합
            </p>
          ...
          >
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 shadow-xl">
              <div className="aspect-video bg-gradient-to-br from-[#71B0FF]/20 to-[#7E72FF]/20 rounded-lg flex items-center justify-center">
                <svg className="w-24 h-24 text-white/80" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M18.5 4H5.5C4.67157 4 4 4.67157 4 5.5V18.5C4 19.3284 4.67157 20 5.5 20H18.5C19.3284 20 20 19.3284 20 18.5V5.5C20 4.67157 19.3284 4 18.5 4Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M9 10.5L11 12.5L15 8.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-gradient-to-br from-[#71B0FF] to-[#7E72FF] rounded-full opacity-50 blur-xl"></div>
            <div className="absolute -top-4 -left-4 w-16 h-16 bg-gradient-to-br from-[#71B0FF] to-[#7E72FF] rounded-full opacity-30 blur-xl"></div>
          </motion.div>
        </div>
      </div>
    </section>
